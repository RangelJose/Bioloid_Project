function [Jv,Jw] = Jg_EE(EE,T,LJoint,parent,axis)
%% Geometric Jacobian matrix
% Inputs:
%    EE = End Effector Position
%    T  = Homogeneus Trasnformations of every link
%    LJoint = Last Joint before the End-effector
...
Jv = zeros(3,24);   % Size of the Jv and Jw 
Jw = zeros(3,24);
...
while i>1                   % Begining the while cycle
    ...
    O_f = EE - T{i}(1:3,4); %Acquisition of On-O's
