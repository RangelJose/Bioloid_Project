...
[T,O,Rots]=body_LF_Transform (Bioloidmodel.NB, Bioloidmodel.LFinPF, Bioloidmodel.axes, q, Bioloidmodel.parent);
...
O_n{3} = T_ee{3}(1:3,4);
O_n{4} = T_ee{4}(1:3,4);
Jg{1} = Jg_EE(O_n{1},O,9,Bioloidmodel.parent,Bioloidmodel.axes,Rots);
Jg{2} = Jg_EE(O_n{2},O,12,Bioloidmodel.parent,Bioloidmodel.axes,Rots);
Jg{3} = Jg_EE(O_n{3},O,18,Bioloidmodel.parent,Bioloidmodel.axes,Rots);
Jg{4} = Jg_EE(O_n{4},O,24,Bioloidmodel.parent,Bioloidmodel.axes,Rots);
...
Pose_RH = [O_n{1};Euler_RH.'];
Pose_LH = [O_n{2};Euler_LH.'];
Pose_RF = [O_n{3};Euler_RF.'];
Pose_LF = [O_n{4};Euler_LF.'];
